var inputID = document.getElementById("hiddenID");
const defaults = {
    "stars": 5,
    "half": false,
    ...
    "readonly": false,
    "click": function (e) {
        inputID = document.getElementById("hiddenID");
        var divID = document.getElementById("textRatingDiv");
        inputID.setAttribute("value", e.stars);
        divID.classList.remove("textRatingDivHidden");
        divID.classList.add("textRatingDiv")
    },
    "value": inputID != null ? inputID.value : 0,
};
